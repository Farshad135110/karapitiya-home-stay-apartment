...
export default function Gallery() {
  ...
  const images = [
    // Bedrooms
    {
      ...
      description:
        "Comfortable bedroom with modern amenities, air conditioning, and dedicated workspace for productivity",
    ...
    },
    {
      ...
      description:
        "Cozy sleeping space with air conditioning and comfortable bedding for restful nights",
    ...
    },
    {
      ...
      description:
        "Spacious room perfect for study and rest with natural lighting and quiet environment",
    ...
    },
    {
      ...
      description:
        "Private bedroom with comfortable furnishing and ample storage space",
    ...
    },
    {
      ...
      description:
        "Fully equipped modern kitchen with refrigerator, stove, and cooking essentials",
    ...
    },
    {
      ...
      description:
        "In-unit washing machine for your convenience during long stays",
    ...
    // Featured bathroom with hot water (key amenity)
    {
      ...
      title: "Modern Bathroom with Hot Water",
      description:
        "Clean bathroom facilities with 24/7 hot water and modern fixtures",
    ...
    },
    {
      ...
      description:
        "Rest area with TV and comfortable seating for entertainment",
