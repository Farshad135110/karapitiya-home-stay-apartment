  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10" aria-hidden="true">
        ...
        <div
          className="absolute top-40 right-20 w-72 h-72 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/2 w-80 h-80 bg-accent-300 rounded-full mix-blend-multiply filter blur-3xl animate-float"
